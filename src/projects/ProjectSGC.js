        ...
        <article className="flex flex-col h-full" data-aos="fade-up">
            ...
            <article className="flex flex-col h-full" data-aos="fade-up">
                <header>
                    ...
                    <a href="https://chat.openai.com/share/7406b069-fe1d-4961-902d-ec2d536f1f50" className="block mb-6" target="_blank" rel="noopener noreferrer">
                        <h3 className="h4 mb-2">
                            <a href="https://chat.openai.com/share/7406b069-fe1d-4961-902d-ec2d536f1f50" className="hover:text-gray-100 transition duration-150 ease-in-out" target="_blank" rel="noopener noreferrer">Project SynergiCoin</a>
                        </h3>
                        <figure className="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                            <img className="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src={require('../images/da3624d7-0c63-4391-be3d-72a99cc1bda1.webp').default} width="352" height="198" alt="Market Place" />
                        </figure>
                    </a>
                    <div className="mb-3">
