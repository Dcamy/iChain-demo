    ...
    return (
        <article className="flex flex-col h-full" data-aos="fade-up">
            ...
            <article className="flex flex-col h-full" data-aos="fade-up">
                <header>
                    <Link to="/blog-post" className="block mb-6">
                        ...
                        <figure className="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                            <img className="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src={require('../images/Wallet.png').default} width="352" height="198" alt="News 01" />
                        </figure>
                    </Link>
                    <div className="mb-3">
                ...
                <p className="text-lg text-gray-400 flex-grow">Project Wallet: Unveil the future of transactions with our cyber-secured wallet. Simple, swift, and fortified with cutting-edge encryption. Your crypto, your control, in a vault of neon brilliance.</p>
